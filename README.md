...
Hi Team! This is my second solution for the Moving Average Problem. The first one is on this PR using
pandas: https://github.com/Unbabel/backend-engineering-challenge/pull/38

* First I want to clarify that I'm not a python developer, but I have experience in batch processing with spring and
  spark. So any improvements that you would like that I do on my code let me know
* Second it was really fun to learn new tools in a short time period

### Requirement: Python3

If you don't have python you can take a look to the **HELP.MD** where you can find installation guidance

## Run the application

```
  python main.py --input_file= files/events.json --window_size=10 --output_file= files/output_file.json
```
